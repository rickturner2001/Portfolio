...
const ProjectsSection = ({
  ...
  return (
    <motion.section
      ...
      className=" flex flex-col p-24 absolute top-0 right-0 z-40 justify-center items-center overflow-y-hidden bg-gradient-to-br from-purple-800 to-gray-900 w-screen min-h-screen"
    >
      <motion.button
        initial={{ opacity: 0 }}
      ...
      <div className="bg-white/20 p-8 relative flex rounded-2xl max-w-7xl mx-auto">
        ...
        <div className="leading-loose bg-white/20  ml-12 p-8 rounded-lg ">
          ...
          <p className="  text-white">
            Tealade is a web-based ecommerce application. It leverages APIs from
            dropshipping and social network companies to enhance its
            ...
            development process was made easier and more efficient thanks to the
            use of TypeScript, which added a type-safe layer on both the
